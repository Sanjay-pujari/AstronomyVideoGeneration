...
public sealed class AstronomyQuestionEngineTests
{
    ...
    public static IEnumerable<object[]> EventQuestionCases()
    {
        ...
        yield return ["SOLAR_ECLIPSE_2026", "SolarEclipse", "Partial Solar Eclipse", new[] { "Sun", "Moon" }, """{ "localVisibility": "Udaipur", "bestViewingWindowLocal": "2026-08-12 16:10–17:20 IST" }""", "2026-08-12 16:10–17:20 IST", new[] { "solar eclipse", "Never view the Sun directly without certified solar viewing glasses", "Sun" }, new[] { "meteor", "radiant" }];
    }
