...
public sealed class Rc2YouTubeShortCheckpointTests
{
    ...
    [Fact]
    public async Task Caption_receives_governed_short_srt_language_and_resumes_without_duplicate_video_or_thumbnail()
    {
        await using var fixture = await Fixture.CreateAsync();
    ...
    private sealed class Fixture : IAsyncDisposable
    {
        ...
        public string CaptionPath => Path.Combine(root, "short.srt");
        ...
        public static async Task<Fixture> CreateAsync()
        {
            ...
            await File.WriteAllTextAsync(Path.Combine(root, "short.mp4"), "video");
            await File.WriteAllTextAsync(Path.Combine(root, "portrait.jpg"), "thumbnail");
            await File.WriteAllTextAsync(Path.Combine(root, "short.srt"), "1\n00:00:00,000 --> 00:00:02,000\nAstronomy caption\n");
            ...
            var row = new Rc2PublishingPublication { Id = Guid.NewGuid(), PlanId = plan.PlanId, PublishingPackageId = "package",
                Phase20AuthorityChecksum = "authority", Target = Rc2PublishingTarget.YouTubeShort, RoleOrMediaType = "roles",
            ...
            var artifacts = new[] { Artifact("ShortVideo", "short.mp4"), Artifact("ThumbnailPortrait", "portrait.jpg"), Artifact("ShortCaptionSrt", "short.srt") };
        ...
        public async Task PublishAsync()
        {
            ...
            await Service.PublishYouTubeShortAsync(row, Plan, Artifacts, CancellationToken.None);
            await Db.SaveChangesAsync();
        }
