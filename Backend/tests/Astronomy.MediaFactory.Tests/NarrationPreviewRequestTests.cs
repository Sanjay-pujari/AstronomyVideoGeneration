...
public sealed class NarrationPreviewRequestTests
{
    ...
    public static IEnumerable<object[]> Phase14FamilyLanguageCases()
    {
        ...
        yield return ["PlanetPairing", "Jupiter Venus Pairing", "Jupiter Venus", "en", new { eventDate = "2026-08-12", localPeakTime = "2026-08-12 05:10 +05:30", skyDirectionHint = "SE" }];
        yield return ["PlanetPairing", "Jupiter Venus Pairing", "Jupiter Venus", "hi", new { eventDate = "2026-08-12", localPeakTime = "2026-08-12 05:10 +05:30", skyDirectionHint = "SE" }];
        yield return ["PlanetPairing", "Mars Jupiter Pairing", "Mars Jupiter", "en", new { eventDate = "2026-11-16", localPeakTime = "2026-11-16 05:30 +05:30", skyDirectionHint = "SE" }];
        yield return ["PlanetPairing", "Mars Jupiter Pairing", "Mars Jupiter", "hi", new { eventDate = "2026-11-16", localPeakTime = "2026-11-16 05:30 +05:30", skyDirectionHint = "SE" }];
