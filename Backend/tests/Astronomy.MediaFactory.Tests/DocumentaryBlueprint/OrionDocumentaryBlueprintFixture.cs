...
internal static class OrionDocumentaryBlueprintFixture
{
    public static DocumentarySceneBlueprint Scene(string id = "scene.orion.belt", int number = 1) => new(
        ...
        [new("Show the three-star line in its constellation context.", "SkyMap", "orion.recognition.belt", null, true), new("Compare the Belt stars' apparent spacing.", "Diagram", "orion.fact.belt-distance", "asset.orion.belt-depth", false)],
    ...
    public static DocumentarySceneBlueprint DistanceScene() => new(
    ...
    public static global::Astronomy.MediaFactory.Core.DocumentaryBlueprint.DocumentaryBlueprint CreateOrdered() => Create([Scene(), DistanceScene()]);
