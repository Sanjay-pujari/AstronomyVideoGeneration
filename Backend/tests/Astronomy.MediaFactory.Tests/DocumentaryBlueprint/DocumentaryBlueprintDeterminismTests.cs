...
{
 [Fact] public void Equivalent_external_inputs_produce_identical_json() { Assert.Equal(JsonSerializer.Serialize(OrionDocumentaryBlueprintFixture.Create()),JsonSerializer.Serialize(OrionDocumentaryBlueprintFixture.Create())); }
