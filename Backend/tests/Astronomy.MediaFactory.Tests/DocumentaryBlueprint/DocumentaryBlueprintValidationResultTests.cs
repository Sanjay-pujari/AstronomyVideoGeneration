...
public sealed class DocumentaryBlueprintValidationResultTests
{
    ...
    [Fact] public void Result_rejects_finding_for_another_blueprint()
    {
        var finding = new DocumentaryBlueprintValidationFinding("code", E, "message", "other-blueprint");

        FluentActions.Invoking(() => new DocumentaryBlueprintValidationResult("blueprint", [finding]))
