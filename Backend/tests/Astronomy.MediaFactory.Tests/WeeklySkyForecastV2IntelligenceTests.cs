...
public sealed class WeeklySkyForecastV2IntelligenceTests
{
    ...
    public async Task V2_Intelligence_Generates_Cinematic_Blueprint()
    {
        ...
        var service = new WeeklySkyForecastV2IntelligenceService(new StubContextBuilder(), new WeeklySkyForecastV2EventIntelligenceBuilder(), new WeeklyAstronomyEventExtractor(), new WeeklySkyForecastV2EditorialIntelligenceBuilder(), new WeeklySkyForecastV2CinematicEditorialRefiner(), new WeeklySkyForecastV2NarrativeAbstractionBuilder(), new WeeklySkyForecastV2NarrationPlanner(), new WeeklySkyForecastV2NarrationTextGenerator(), new WeeklySkyForecastV2AssetResolver(), new WeeklySkyForecastV2EditorialNormalizer(), new WeeklyStoryboardComposer(), Options.Create(new RenderingOptions { WorkingDirectory = workingDirectory }), new Microsoft.Extensions.Logging.Abstractions.NullLogger<WeeklySkyForecastV2IntelligenceService>());
    ...
    {
        return new WeeklySkyForecastV2IntelligenceResponse(
            ContentGenerationPlanId: null,
            Category: "WeeklySkyForecast",
            Success: true,
            WeekStartDate: new DateOnly(2026, 5, 22),
            WeekEndDate: new DateOnly(2026, 5, 28),
            ...
            RecommendedVisualStrategies: ["Hybrid"],
            Warnings: [],
            StepResults: []);
    }
