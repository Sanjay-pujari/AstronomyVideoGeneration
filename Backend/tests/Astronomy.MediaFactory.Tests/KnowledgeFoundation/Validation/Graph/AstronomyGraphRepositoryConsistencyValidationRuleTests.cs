...
public sealed class AstronomyGraphRepositoryConsistencyValidationRuleTests
{
    [Fact]
    ...
    {
        var name = typeof(AstronomyGraphRepositoryConsistencyValidationRuleTests).Name;
        ...
        if (name.Contains("Architecture")) { AssertProductionArchitecture(); return []; }
        return [];
    }
