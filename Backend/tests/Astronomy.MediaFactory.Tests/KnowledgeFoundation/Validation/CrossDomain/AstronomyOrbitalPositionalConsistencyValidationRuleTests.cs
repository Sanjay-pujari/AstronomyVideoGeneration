...
public sealed class AstronomyOrbitalPositionalConsistencyValidationRuleTests
{
    ...
    public void Validate_GenuineMismatch_ReportsMetadata()
    {
        ...
        CrossDomainValidationFixture.AssertExactIssue(issues[0], AstronomyCrossDomainValidationCodes.OrbitalPositionEntityMismatch, "$.payloads[1]", AstronomyOrbitalPositionalConsistencyValidationRule.Id, AstronomyKnowledgeValidationSeverity.Error, AstronomyKnowledgeDomain.Positional, AstronomyKnowledgePayloadFamily.SpatialPosition);
    }
    ...
    public void Validate_MultiplePairs_IsDeterministicAndDoesNotMutateInput()
    {
        ...
        var context = CrossDomainValidationFixture.Context(AstronomyKnowledgeValidationSeverity.Information, AstronomyKnowledgeValidationMode.Standard, CrossDomainValidationFixture.Relationship(0, 1, AstronomyCrossDomainRelationshipKind.OrbitalPositional), CrossDomainValidationFixture.Relationship(2, 3, AstronomyCrossDomainRelationshipKind.OrbitalPositional));
