...
internal static class ValidationFixture
{
    ...
    public static AstronomyEntityClassificationPayload Classification(params AstronomyClassificationAssignment[] assignments) => new(new AstronomyKnowledgeTypeId("typed.classification.entity.v1"), AstronomyEntityKind.Planet, assignments.Length == 0 ? [Assignment()] : assignments);
