...
using LanguageProfile =
    Astronomy.MediaFactory.Infrastructure.Orchestration.RC2.LanguageProfile;

using LanguageProfileResolver =
    Astronomy.MediaFactory.Infrastructure.Orchestration.RC2.LanguageProfileResolver;

using SemanticResolvedFact =
    Astronomy.MediaFactory.Infrastructure.Production.Narration.Semantics.Contracts.ResolvedSemanticFact;

namespace Astronomy.MediaFactory.Tests;

public sealed class SemanticFactValueRealizerRegressionTests
{
    private static readonly LanguageProfile English =
    ...
    public void AstronomicalObjectArraysRealizeAsStableObjectNames()
    {
        ...
        var text = SemanticFactValueRealizer.Instance.RealizeCandidateValue(
            objects,
            capability: "AstronomicalObjects");
    ...
    {
        var fact = new SemanticResolvedFact(
            "ApparentPairingScience",
            "ApparentPairingScience",
            new DomainScientificKnowledgeValue(
                null,
                "They appear close because of line-of-sight geometry from Earth.",
                null,
                null),
            null,
            "DomainScientificKnowledge",
            "test",
            "science",
            null,
            ...
            "en",
            true,
            sourceInputs: Array.Empty<string>());
    ...
    {
        var location = new ObservationLocationValue(
            "Udaipur, Rajasthan",
            24.58m,
            73.68m,
            null,
        ...
        var text = SemanticFactValueRealizer.Instance.RealizeCandidateValue(
            location,
            capability: "ObservationLocation");
    ...
    public void RequiredUnsupportedStructuredValueBlocksWithDiagnostic()
    {
        ...
        Assert.Equal(
            "UnsupportedStructuredSemanticValue",
            realized.DiagnosticCode);
    ...
    public void OptionalUnsupportedStructuredValueOmitsSafely()
    {
        var fact = new SemanticResolvedFact(
            ...
            SemanticVerificationStatus.Verified,
            1m,
            SemanticFactRequiredness.Optional,
            null,
            null,
            "en",
            true,
