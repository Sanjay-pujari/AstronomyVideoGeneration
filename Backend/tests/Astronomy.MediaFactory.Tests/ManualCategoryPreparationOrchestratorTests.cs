...
public sealed class ManualCategoryPreparationOrchestratorTests
{
    ...
    {
        var plan = new ContentGenerationPlan { ContentCategoryCode = category, Status = "Planned", Language = "hi", RegionId = "IN-RJ-UDAIPUR", ScheduledUtc = DateTimeOffset.UtcNow };
