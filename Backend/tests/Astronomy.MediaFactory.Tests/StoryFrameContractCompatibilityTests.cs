...
{
    [Theory]
    [InlineData("1.0", true)] [InlineData("1.1", true)]
    [InlineData(null, false)] [InlineData("", false)] [InlineData("1", false)] [InlineData("1.2", false)]
    ...
    [Theory]
    [InlineData("1.0", 1, 0)] [InlineData("1.1", 1, 1)]
