...
public sealed class PipelineAlertEmissionTests
{
    ...
    private sealed class NoOpSpeechService : ISpeechSynthesisService { public Task<string> SynthesizeAsync(string script, string outputDirectory, CancellationToken cancellationToken) => Task.FromResult("x"); public Task SynthesizeToFileAsync(string script, string outputPath, CancellationToken cancellationToken) => Task.CompletedTask; }
