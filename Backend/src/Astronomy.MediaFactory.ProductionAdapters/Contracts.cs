...
public interface IDocumentaryProductionAdapterRegistry { IDocumentaryProductionVisualAdapter? VisualGeneration { get; } IDocumentaryProductionNarrationAdapter? NarrationSynthesis { get; } IDocumentaryProductionSubtitleAdapter? SubtitleGeneration { get; } IDocumentaryProductionSceneCompositionAdapter? SceneComposition { get; } bool IsAvailable(DocumentaryProductionOperationKind operation); }
