...
public interface IDocumentaryProductionAdapterRegistry { IDocumentaryProductionVisualAdapter? VisualGeneration { get; } IDocumentaryProductionNarrationAdapter? NarrationSynthesis { get; } IDocumentaryProductionSubtitleAdapter? SubtitleGeneration { get; } IDocumentaryProductionSceneCompositionAdapter? SceneComposition { get; } IDocumentaryProductionVariantCompositionAdapter? VariantComposition { get; } bool IsAvailable(DocumentaryProductionOperationKind operation); }
