...
public static class ThumbnailCompositionProfiles
{
    ...
    public static readonly CompositionProfile LandscapeProfile = new("LandscapeProfile", "16:9", ["YouTube", "Website"], ["wide cinematic composition", "balanced horizon", "strong negative space", "object occupies roughly 35-45% of frame", "safe text area", "finished-thumbnail layout guidance"], ["COMPOSITION PROFILE: LandscapeProfile for 16:9 YouTube and website surfaces.", "Use wide cinematic framing, balanced horizon, strong negative space, safe text area, and premium documentary layout guidance.", "Keep the dominant event object roughly 35-45% of the frame without squeezing, padding, or borrowing another aspect-ratio layout."], ["Landscape prompt must be generated natively for 16:9.", "CompositionProfile controls framing, negative space, object dominance, safe text area, and finished-thumbnail layout guidance."]);
