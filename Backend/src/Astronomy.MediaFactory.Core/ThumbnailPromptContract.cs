...
public static class ThumbnailCompositionProfiles
{
    ...
    public static readonly CompositionProfile PortraitProfile = new("PortraitProfile", "9:16", ["YouTube Shorts", "Instagram Reels"], ["premium YouTube Shorts cover", "Netflix astronomy documentary hierarchy", "National Geographic editorial polish", "Apple Event typography discipline", "massive premium title", "beautiful circular celestial artwork", "small luxury glass observation card", "native vertical composition", "never stretched celestial objects", "avoid AI poster feeling"], ["COMPOSITION PROFILE: PortraitProfile for native 9:16 YouTube Shorts and Instagram Reels covers.", "Use portrait cover art direction: a massive premium title as the first read, beautiful circular event-only celestial artwork as the emotional center, and a small luxury glass observation card as the quiet support element.", "Design vertically from the beginning like a Netflix astronomy documentary cover, National Geographic magazine cover, Apple Event poster, or premium space magazine; this must not feel like a resized landscape, cropped poster, infographic, scientific report, or generic AI-generated poster.", "Keep every planet, moon, or celestial disk perfectly circular with physically correct geometry; never stretch, squash, elongate, or turn objects into vertical ovals.", "Increase celestial importance only through camera framing, perspective, composition, negative space, and atmospheric lighting, never through distorted scaling.", "Render only the event objects named in the contract; never invent unrelated planets, moons, labels, duplicate labels, watermarks, decorative filler objects, or empty sky that competes with the hierarchy.", "Use premium dark blue astronomy-documentary atmosphere, gold accents, elegant glow, clean luxury typography, mobile-first readability, generous breathing room, and professional editorial restraint.", "The observation card must be small, glassy, Apple Weather quality, compact, and subordinate to the artwork; no side panels, no guide table, no bottom strip, no action prompt, no large card, no observation window."], ["Portrait prompt must be generated natively for 9:16.", "CompositionProfile controls portrait framing, object dominance, phone readability, premium editorial hierarchy, scientific object integrity, and the cover-first hierarchy."]);
