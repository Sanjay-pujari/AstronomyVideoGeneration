...
public sealed class DocumentaryProductionCertificationSummarizer
{
    public DocumentaryProductionCertificationSummary Summarize(DocumentaryProductionCertificationRecord record)
    {
        ...
        var summary=new DocumentaryProductionCertificationSummary(record.ProductionCertificationId,record.PipelineExecutionId,record.MediaProjectId,record.MaterializationId,record.TopicId,record.MediaProject.TopicProfile.TopicFamily,record.VariantCount,
        ...
        DocumentaryProductionCertificationValidator.ValidateSummary(summary);return summary;
    }
}
