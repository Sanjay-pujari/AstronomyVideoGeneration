...
[JsonConverter(typeof(JsonStringEnumConverter))] public enum AstronomyFamilyKind { Event, CelestialObject, SkyPattern, ObservationTopic, CulturalTopic, ScientificTopic, HistoricalTopic, MissionTopic }
