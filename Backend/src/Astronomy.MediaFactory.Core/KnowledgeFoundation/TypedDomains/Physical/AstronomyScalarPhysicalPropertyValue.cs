...
{
    public AstronomyScalarPhysicalPropertyValue(AstronomyMeasurement measurement) { Measurement = measurement ?? throw new ArgumentNullException(nameof(measurement)); }
