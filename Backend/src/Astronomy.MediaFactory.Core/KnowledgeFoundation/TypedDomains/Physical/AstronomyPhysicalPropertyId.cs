...
public readonly record struct AstronomyPhysicalPropertyId
{
    ...
    public AstronomyPhysicalPropertyId(string value)
    {
        Value = KnowledgeId.NormalizeToken(value, nameof(value), "Astronomy physical property ID", MaxLength).ToLowerInvariant();
    }
