...
{ public static IServiceCollection AddAstronomyKnowledgeCatalog(this IServiceCollection services){ ArgumentNullException.ThrowIfNull(services); services.AddCgA2AstronomyKnowledgeFoundation(); services.AddAstronomyClassificationAndPhysicalValidation(); services.AddAstronomyOrbitalAndPositionalValidation(); services.AddAstronomyObservationalAndVisibilityValidation(); services.AddAstronomyEventAndTemporalValidation(); services.AddAstronomyCrossDomainValidation(); services.AddAstronomyKnowledgeGraphValidation(); services.TryAddSingleton<IAstronomyKnowledgeCatalogBuilder,AstronomyKnowledgeCatalogBuilder>(); services.TryAddSingleton<IAstronomyKnowledgeCatalog>(p=>new AstronomyKnowledgeCatalog(p.GetRequiredService<IAstronomyKnowledgeCatalogBuilder>().Build())); return services; } }
