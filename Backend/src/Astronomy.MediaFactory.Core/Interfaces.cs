...
public sealed record WeeklySkyForecastV2GenerateWeeklyScenesResponse(
    ...
    bool ExpandedNightGeometryReady = false,
    DateTime? ExpandedSelectedObservationUtc = null,
    DateTime? ExpandedSelectedObservationLocal = null,
    double? ExpandedSelectedSunAltitudeDeg = null,
    string ExpandedNightValidationStatus = "NotValidated",
    IReadOnlyList<string>? FailedExpandedAssetReasons = null,
    ...
    double LongformActualDurationSeconds = 0,
    double ShortformActualDurationSeconds = 0,
