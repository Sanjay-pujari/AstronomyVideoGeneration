    ...
    string? Reason = null)
{
    ...
    public string? PublishingPackageId { get; init; }
    public bool? PublicationPackageReady { get; init; }
    public bool? PublishGateChecked { get; init; }
    public bool? PublishApproved { get; init; }
