...
public sealed class VisualCreativeDirector : IVisualCreativeDirector
{
    ...
    private static DirectionModel BuildModel(VisualIntelligenceOrchestrationContext context, FamilyCreativeProfileResult profile)
    {
