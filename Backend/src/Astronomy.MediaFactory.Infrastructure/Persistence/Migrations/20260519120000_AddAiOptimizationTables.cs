...
public partial class AddAiOptimizationTables : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.CreateTable(
            ...
            constraints: table => table.PrimaryKey("PK_hook_optimization_results", x => x.Id));
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table => table.PrimaryKey("PK_thumbnail_optimization_results", x => x.Id));
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table => table.PrimaryKey("PK_trend_signals", x => x.Id));
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table => table.PrimaryKey("PK_publishing_optimization_results", x => x.Id));
    }

    protected override void Down(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.DropTable(name: "hook_optimization_results");
        migrationBuilder.DropTable(name: "thumbnail_optimization_results");
        migrationBuilder.DropTable(name: "trend_signals");
        migrationBuilder.DropTable(name: "publishing_optimization_results");
    }
}
