    ...
    public AstronomyInfographicDesignTemplate CreateTemplate(AstronomyInfographicDesignRequest request)
    {
        ...
        return questionType switch
        {
            "what" => new(
                ...
                "YouTube-quality astronomy thumbnail with a professional astronomy magazine cover feel, western twilight over Rajasthan, strong golden-orange horizon glow, reduced-scale Venus/Jupiter sky targets, and premium title typography.",
                0.25,
                0.75,
                ...
                ["background:professional astronomy magazine cover western twilight over Rajasthan with natural atmospheric glow", "horizon:strong golden-orange western horizon glow", "texture:documentary twilight haze and subtle sky grain", "composition:strong focal contrast clickable thumbnail composition", "vignette:natural edge falloff", "celestial:reduced-scale local transparent Venus and Jupiter sky targets integrated with atmospheric blending and subtle glow", "typography:premium thumbnail title Venus & Jupiter subtitle After sunset"],
            ...
            "why" => new(
                ...
                ["background:deep astronomy sky premium editorial background with atmospheric starfield depth", "celestial:two of the brightest worlds sharing the evening sky as reduced-scale sky targets integrated with atmospheric blending and subtle glow", "significance:shared sky brightness emotional significance for human interest", "comparison:brightness feel", "direction:closeness bracket", "annotation:floating human-interest significance line"],
            ...
            "action" => new(
                ...
                "Shareable poster-quality astronomy artwork with cinematic twilight, Venus/Jupiter together as sky targets, premium composition, and only a minimal call to action.",
                0.25,
                0.75,
                ...
                ["background:most beautiful poster-quality cinematic twilight premium astronomy artwork with atmospheric depth", "horizon:warm peaceful golden-orange western horizon", "composition:premium shareable poster composition", "celestial:local Venus and Jupiter reduced-scale sky targets naturally integrated with atmospheric blending and subtle glow", "typography:minimal CTA Step Outside Tonight Look west", "layout:minimal astronomy poster"],
