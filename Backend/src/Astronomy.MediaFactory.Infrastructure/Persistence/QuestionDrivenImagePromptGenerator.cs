...
public sealed class QuestionDrivenImagePromptGenerator : IQuestionDrivenImagePromptGenerator
{
    public string GeneratePrompt(QuestionDrivenImagePromptRequest request)
    {
        ...
        {
            "what" => "meteor shower peak-night alert, cinematic dark night sky over Udaipur India, multiple meteor streaks, subtle shower radiant constellation hint, premium astronomy magazine cover mood",
            "where" => "dark open sky viewing guide over Udaipur, east-to-overhead sky orientation, meteor streaks, subtle shower radiant marker, low light pollution context",
            ...
            "why" => "premium editorial meteor shower sky with abundant meteor streaks, strong annual meteor shower mood, low moon interference, subtle shower radiant",
        ...
        var planetInstruction = isMeteorShower
            ? "No unrelated planets, no object-pairing visuals; include meteor streaks, dark night sky, and optional subtle radiant only."
        ...
        return string.Join(' ', new[]
        {
            ...
            sceneMood + ".",
            isMeteorShower ? "Include dark night sky, meteor streaks, atmospheric depth, Udaipur/India viewing context, and subtle shower radiant or constellation hint." : "Include sky, horizon, atmosphere, and landscape only.",
