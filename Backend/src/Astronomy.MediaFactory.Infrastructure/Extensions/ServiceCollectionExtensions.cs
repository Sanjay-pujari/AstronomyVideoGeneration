...
using Astronomy.MediaFactory.Infrastructure.Production.Narration.Semantics.Sources.Adapters.Knowledge;
...
public static class ServiceCollectionExtensions
{
    ...
    public static IServiceCollection AddMediaFactory(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddHttpClient<IRc2FacebookPhotoApiClient, Rc2FacebookPhotoApiClient>(client => client.Timeout = TimeSpan.FromSeconds(60));
        ...
        services.AddScoped<IRc2PublishingExecutionService, Rc2PublishingExecutionService>();
        ...
        services.AddScoped<Astronomy.MediaFactory.Core.DocumentaryBlueprint.IPhase7NarrationRuntimeAuthorityLoader,
            Astronomy.MediaFactory.Infrastructure.DocumentaryBlueprint.Phase7NarrationRuntimeAuthorityLoader>();
        ...
        services.AddSingleton<Astronomy.MediaFactory.Infrastructure.DocumentaryBlueprint.IPhase4CommittedStateValidator, Astronomy.MediaFactory.Infrastructure.DocumentaryBlueprint.Phase4CommittedStateValidator>();
        services.AddSingleton<Astronomy.MediaFactory.Infrastructure.DocumentaryBlueprint.IPhase4PublicationFaultInjector, Astronomy.MediaFactory.Infrastructure.DocumentaryBlueprint.Phase4PublicationFaultInjector>();
        ...
        services.AddSingleton<Astronomy.MediaFactory.Core.DocumentaryBlueprint.INarrationPlanningDraftRealizabilityPolicy, Astronomy.MediaFactory.Infrastructure.DocumentaryBlueprint.DeterministicNarrationPlanningDraftRealizabilityPolicy>();
        ...
        services.AddSingleton<Astronomy.MediaFactory.Core.DocumentaryBlueprint.IPhase7NarrationPlanningCandidateReadback, Astronomy.MediaFactory.Infrastructure.DocumentaryBlueprint.Phase7NarrationPlanningCandidateReadback>();
        services.AddSingleton<Astronomy.MediaFactory.Core.DocumentaryBlueprint.IPhase7NarrationPlanningArtifactReconciler, Astronomy.MediaFactory.Infrastructure.DocumentaryBlueprint.Phase7NarrationPlanningArtifactReconciler>();
        services.AddSingleton<Astronomy.MediaFactory.Core.DocumentaryBlueprint.IPhase7NarrationPlanningClock, Astronomy.MediaFactory.Infrastructure.DocumentaryBlueprint.Phase7NarrationPlanningClock>();
        services.AddSingleton<Astronomy.MediaFactory.Core.DocumentaryBlueprint.IPhase7NarrationPlanningPublicationFaultInjector, Astronomy.MediaFactory.Infrastructure.DocumentaryBlueprint.Phase7NarrationPlanningPublicationFaultInjector>();
        ...
        services.AddSingleton<Astronomy.MediaFactory.Core.DocumentaryBlueprint.IPhase7FoundationFileSystem, Astronomy.MediaFactory.Infrastructure.DocumentaryBlueprint.Phase7FoundationFileSystem>();
        services.AddSingleton<Astronomy.MediaFactory.Core.DocumentaryBlueprint.IPhase7FoundationExecutionLock, Astronomy.MediaFactory.Infrastructure.DocumentaryBlueprint.Phase7FoundationExecutionLock>();
        ...
        services.AddSingleton<Astronomy.MediaFactory.Core.DocumentaryBlueprint.IPhase7KnowledgeExecutionLock, Astronomy.MediaFactory.Infrastructure.DocumentaryBlueprint.Phase7KnowledgeExecutionLock>();
        services.AddSingleton<Astronomy.MediaFactory.Core.DocumentaryBlueprint.IPhase7KnowledgeRecoveryService, Astronomy.MediaFactory.Infrastructure.DocumentaryBlueprint.Phase7KnowledgeRecoveryService>();
        services.AddSingleton<Astronomy.MediaFactory.Core.DocumentaryBlueprint.IPhase7KnowledgeCommittedStateEvaluator, Astronomy.MediaFactory.Infrastructure.DocumentaryBlueprint.Phase7KnowledgeCommittedStateEvaluator>();
        ...
        services.AddScoped<ISceneAssetCertificationService, SceneAssetCertificationService>();
