...
public static class ServiceCollectionExtensions
{
    ...
    public static IServiceCollection AddMediaFactory(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddSingleton<Astronomy.MediaFactory.Core.DocumentaryBlueprint.IPhase7KnowledgeReferenceIdentityBridge>(sp => (Astronomy.MediaFactory.Core.DocumentaryBlueprint.IPhase7KnowledgeReferenceIdentityBridge)sp.GetRequiredService<Astronomy.MediaFactory.Core.DocumentaryBlueprint.IPhase7KnowledgeReferenceResolver>());
