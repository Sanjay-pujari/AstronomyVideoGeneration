...
public sealed class AstronomyFamilyProfileCatalogV1 : IAstronomyFamilyProfileCatalogV1
{
    ...
    [
        Profile("PlanetPairing","Event",["Hook","Orientation","Timing","Observation","Science","Closing"],["EventIdentity","AstronomicalObjects","EventWindow","DomainScientificKnowledge"],["ObservationDirection","ObservationLocation","AngularSeparation","ObservationEquipment","ObservationConditions","EditorialContext"]),
        ...
        Profile("Constellation","Reference",["Hook","Identification","Orientation","Science","Significance","Closing"],["ObjectKnowledge"],["EventIdentity","ObservationDirection","CulturalNameContext","EditorialContext"],null,false),
