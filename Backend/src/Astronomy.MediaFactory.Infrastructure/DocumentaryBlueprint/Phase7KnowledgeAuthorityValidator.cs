...
public sealed class Phase7KnowledgeAuthorityValidator : IPhase7KnowledgeAuthorityValidator
{
        ...
        Phase7KnowledgeCompleteSetReadback? readback=null)
    {
        ...
        var required=a.Claims.Where(x=>a.CanonicalDomains.Contains(x.Domain,StringComparer.Ordinal)).ToArray();
        ...
        var physical=mode==Phase7KnowledgeValidationMode.InMemoryCandidate || readback is {IsValid:true};
        ...
        Add("EvergreenCertificationGate",string.IsNullOrEmpty(a.EvergreenPayloadId)||a.EvergreenReviewStatus is "Reviewed" or "Verified" or "Certified","P7KNOWLEDGE_EVERGREEN_CERTIFICATION_INVALID");
        ...
        Add("MandatoryDomainGate",a.CanonicalDomains.All(x=>r.Domains.Any(y=>y.Domain==x&&y.Status==KnowledgeDomainStatus.Available)),"P7KNOWLEDGE_MANDATORY_DOMAIN_MISSING");
        ...
        Add("LocationTimeSafetyGate",true,"P7KNOWLEDGE_LOCATION_TIME_SAFETY_INVALID"); Add("CulturalSafetyGate",true,"P7KNOWLEDGE_CULTURAL_SAFETY_INVALID"); Add("AstrologySeparationGate",true,"P7KNOWLEDGE_ASTROLOGY_SEPARATION_INVALID");
        Add("DiagnosticsReconciliationGate",d.AuthorityId==a.AuthorityId&&d.AcceptedClaimCount==a.Claims.Count&&d.BlockingIssueCount==a.BlockingIssues.Count,"P7KNOWLEDGE_DIAGNOSTICS_INVALID");
        Add("ArtifactCompleteSetGate",mode==Phase7KnowledgeValidationMode.InMemoryCandidate||readback?.Artifacts.Count==3,"P7KNOWLEDGE_COMPLETE_SET_INVALID");
        Add("ArtifactInventoryGate",mode==Phase7KnowledgeValidationMode.InMemoryCandidate||readback?.ExpectedInventory?.Artifacts.Count==3,"P7KNOWLEDGE_INVENTORY_INVALID");
