...
public sealed class FamilyNarrationProfileResolver : IFamilyNarrationProfileResolver
{
    ...
    public FamilyNarrationProfileResolver()
    {
        ...
        Alias(map, "CONJUNCTION", "GROUPING", "OCCULTATION", "TRANSIT", "OPPOSITION", "ELONGATION", "CLOSE_APPROACH", "PLANET_GROUPING", "PLANET_CONJUNCTION");
    ...
    private static FamilyNarrationProfile CreateConstellation()
    {
        ...
        var draft = new FamilyNarrationProfile("constellation-documentary-v1", Phase7FoundationContract.Version, "CONSTELLATION", ["en","hi"],
            new(10,12,15,new(480,600,900),mandatory,["deep-sky","astrophotography","modern-research"],order,"Open with recognition, not unsupported spectacle.","Close with an evidence-grounded observing invitation."),
            ...
            ["DeepSkyObjects","Astrophotography","ModernResearch","IndianOrRegionalTraditions"], safety,
