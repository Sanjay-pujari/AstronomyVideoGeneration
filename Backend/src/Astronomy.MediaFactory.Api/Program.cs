...
var sscResult = splitProbeSsc;
        ...
        await File.WriteAllTextAsync(narrationManifestPath, JsonSerializer.Serialize(new
        {
            ...
            assetRealization = new
            {
                ...
                failedNASAAssetCount = assetRealization.PlannedNASAAssetCount - assetRealization.ProductionReadyNASAAssetCount,
        ...
        var output = new WeeklySkyForecastV2GenerateWeeklyScenesResponse(
            ...
            Math.Max(0, assetRealization.PlannedNASAAssetCount - assetRealization.ProductionReadyNASAAssetCount),
