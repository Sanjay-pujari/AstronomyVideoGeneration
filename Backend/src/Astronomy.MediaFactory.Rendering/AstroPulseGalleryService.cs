...
public sealed class AstroPulseGalleryService(IOptions<AzureOpenAIForImageOptions> imageOptions) : IAstroPulseGalleryService
{
    ...
    public async Task<AstroPulseGalleryResult> GenerateGalleryAsync(string outputDirectory, AstroPulseGalleryAspect aspect, CancellationToken cancellationToken)
    {
        ...
        var visualQualityFrameworkReviewPath = Path.Combine(diagnosticsDirectory, "VisualQualityFrameworkReview.json");
        var visualPromptPolicyReviewPath = Path.Combine(diagnosticsDirectory, "VisualPromptPolicyReview.json");
        ...
        await File.WriteAllTextAsync(visualQualityFrameworkReviewPath, JsonSerializer.Serialize(VisualQualityFramework.Astronomy().CreateReview("Gallery"), JsonOptions), cancellationToken);
    ...
    private static object BuildVisualPromptDiagnostics(GalleryContext context, IReadOnlyList<GalleryTopic> topics)
    {
        ...
        return new
        {
            ...
            visualQualityFramework = VisualQualityFramework.Astronomy().CreateReview("Gallery"),
