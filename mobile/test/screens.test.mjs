...
test('mobile home model renders AstroPulse branding with mock sky data', () => {
  ...
  assert.deepEqual(model.navigation.bottomTabs.map((tab) => tab.id), ['home', 'sky', 'events', 'videos', 'settings']);
...
test('sky, events, videos, and settings screens render with mock data', () => {
