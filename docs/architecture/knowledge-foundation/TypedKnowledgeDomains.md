...
The built-in registry is explicit: `AstronomyBuiltInTypedPayloadDescriptors.BuiltIn` is registered by `AddAstronomyTypedKnowledge`. No reflection or plugin scanning is used.
