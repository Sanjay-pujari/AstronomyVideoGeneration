# ADR-003 — Certification does not own astronomy knowledge
...
## Decision
Certification consumes evidence and reports decisions, but CG-A2 domain contracts own astronomy identity, classification, relationships, localization, and sources.
