# ADR-004 — Canonical identity is language-neutral
...
## Decision
AstronomyEntityIdentity is canonical and language-neutral. Multiple AstronomyLocalizedContent records can describe one EntityId.
