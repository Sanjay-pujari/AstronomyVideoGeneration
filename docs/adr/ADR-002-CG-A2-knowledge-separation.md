# ADR-002 — Scientific and cultural knowledge remain separate
...
## Decision
Scientific classifications, historical attribution, cultural usage notes, and localized display text remain separate typed contracts rather than a single untyped description.
